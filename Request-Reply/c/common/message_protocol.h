...
void create_channels_list_message(int64_t clock, msgpack_sbuffer* buffer);
...
void create_history_message(const char* channel, int64_t clock, msgpack_sbuffer* buffer);
...
void print_channels_list(msgpack_object* data);
void print_message_history(msgpack_object* data);
